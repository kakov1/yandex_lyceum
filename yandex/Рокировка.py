...
class Board:
    ...
    def castling0(self):
        if self.color == WHITE:
            if isinstance(self.field[0][0], Rook) and isinstance(self.field[0][4], King) and\
                    not any(self.field[0][1:4]):
                if self.field[0][0].check and self.field[0][4].check:
            ...
            if isinstance(self.field[7][0], Rook) and isinstance(self.field[7][4], King) and\
                    not any(self.field[7][1:4]):
                if self.field[7][0].check and self.field[7][4].check:
    ...
    def castling7(self):
        if isinstance(self.field[0][7], Rook) and isinstance(self.field[0][4], King) and\
                    not any(self.field[0][5:7]):
            if self.color == WHITE:
                if self.field[0][4].check and self.field[0][7].check:
            ...
            if isinstance(self.field[7][7], Rook) and isinstance(self.field[7][4], King) and\
                    not any(self.field[7][5:7]):
                if self.field[7][4].check and self.field[7][7].check:
